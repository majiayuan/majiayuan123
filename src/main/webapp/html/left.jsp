                                        ...
                                        <div id="menu_14" style="DISPLAY: none">
                                            <table width="100%" border="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td nowrap>
                                                        <a href="${pageContext.request.contextPath}/user/toAddUser" target="mainFrame" class="a03">添加用户</a>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table width="100%" border="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td nowrap>
                                                        <%--进入findCurrentPage--%>
                                                        <a href="${pageContext.request.contextPath}/user/findCurrentPage" target="mainFrame" class="a03">用户管理</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <div id="menu_15" style="DISPLAY: none">
                                            ...
                                            <table width="100%" border="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td nowrap>
                                                        <a href="${pageContext.request.contextPath}/html/person_manage/部门管理.jsp" target="mainFrame" class="a03">部门管理</a>
                                                    </td>
                                                </tr>
